...
const RateLimits = () => {
  ...
  return (
    <div className="documentation-container max-w-5xl px-20">
      {/* intro */}
      <div>
        <h1 className="text-3xl font-bold mb-4">Rate Limits & Usage Tiers</h1>
      </div>
      <section id="tier-system-overview" className="mb-10">
      ...
      {/* usage tiers */}
      <section id="rate-limits-features" className="mb-10">
            ...
            <div className="flex items-start space-x-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-muted-foreground">
                  Your tier level is determined by your total credit purchases
                  over time. Higher tiers unlock increased rate limits and
                  additional features.
                </p>
              </div>
            </div>
          ...
          <Card className="flex-1 rounded-lg bg-background border border-borderColorPrimary p-4">
            <div className="flex items-start space-x-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-muted-foreground">
                  Purchase credits at any time to increase your tier level. Tier
                  benefits are applied automatically based on your total
                  spending.
                </p>
              </div>
            </div>
        ...
        <Card className="rounded-lg bg-background border border-borderColorPrimary p-6">
          <div className="flex items-start space-x-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                {` We integrate models from multiple providers (e.g. OpenAI,
                Stability, ElevenLabs, etc.). While we don't own these models,
                we enable you to interact with them seamlessly via our API. Your
                usage may be subject to the underlying provider's availability
                and policies.`}
              </p>
            </div>
          </div>
        ...
        <div className="rounded-lg  bg-background border border-borderColorPrimary p-6">
          <div className="flex items-start space-x-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                You can upgrade your tier by purchasing API credits. Your tier
                is based on your total spend across all time. To upgrade, go to{" "}
